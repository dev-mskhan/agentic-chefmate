  ...
  return (
    <section className="bg-terracotta px-4 py-20 text-cream sm:px-8 lg:px-12 lg:py-28 2xl:px-16">
      <div className="mx-auto grid max-w-[1500px] gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-20">
        ...
        <div><p className="text-xs font-semibold uppercase tracking-[0.2em] text-cream/70">Meet the chefs</p><h2 className="mt-4 max-w-[14ch] font-display text-5xl leading-[0.95] tracking-[-0.035em] sm:text-6xl">Every menu starts with care.</h2><p className="mt-6 max-w-[32ch] text-lg leading-8 text-cream/80">Meet the chefs who prepare family recipes and fresh ideas for local customers.</p><Link to="/discover?type=chefs" className="mt-8 inline-flex rounded-pill bg-cream px-5 py-3 text-sm font-semibold text-terracotta-dark transition-colors hover:bg-saffron">Meet the chefs</Link></div>
      </div>
    </section>
  )
}
