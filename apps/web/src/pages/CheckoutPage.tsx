...
export function CheckoutPage() {
  ...
  if (!cart) return <PublicShell><PageContainer>  <EmptyState icon={ShoppingBasket} title="Your basket is empty" description="Choose a dish before checkout." action={<Link to="/discover?type=dishes" className="inline-flex min-h-11 items-center rounded-pill bg-terracotta px-5 text-sm font-semibold text-cream">Browse dishes</Link>} /></PageContainer></PublicShell>
