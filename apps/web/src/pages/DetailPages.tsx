...
function DetailLayout({ children }: { children: ReactNode }) {
  return <PublicShell navigation={[{ label: 'Discover', href: '/discover' }, { label: 'Chefs', href: '/discover?type=chefs' }, { label: 'Dishes', href: '/discover?type=dishes' }, { label: 'Meal plans', href: '/discover?type=meal-plans' }, { label: 'Cart', href: '/cart' }]}>{children}</PublicShell>
}
