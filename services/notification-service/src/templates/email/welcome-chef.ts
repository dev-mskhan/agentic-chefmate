export function welcomeChefTemplate() {
  return {
    subject: "You're now a chef on Foodlancer!",
    html: `
      <h1>Congratulations, Chef!</h1>
      <p>Your account has been upgraded to Chef status on Foodlancer.</p>
    ...
    `,
    text: "Congratulations! You're now a chef on Foodlancer. Visit your dashboard to get started.",
  }
}
