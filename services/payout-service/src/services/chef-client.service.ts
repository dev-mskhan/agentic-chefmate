/**
 * Resolves chef profile ID from auth userId by calling chef-service.
 * Similar to order-service's resolveChefIdFromUserId.
 */
import { config } from '../config'
import { ForbiddenError } from '@chefmate/errors'
import { createLogger } from '@chefmate/logger'

const logger = createLogger('payout-service:chef-client')
