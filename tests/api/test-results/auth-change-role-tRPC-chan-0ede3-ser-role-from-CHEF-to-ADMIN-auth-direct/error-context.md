...
- Name: auth\change-role.spec.ts >> tRPC changeRole (internalProcedure) >> changes a user role from CHEF to ADMIN
- Location: tests\auth\change-role.spec.ts:31:7

# Error details

```
Error: signup failed for test+1786287261976+lye9del83tq@chefmate.test: {"result":{"data":{"userId":"6a78949fbcaf660c09e36637","email":"test+1786287261976+lye9del83tq@chefmate.test","role":"USER"}}}
