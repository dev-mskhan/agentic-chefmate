...
- Name: auth\change-role.spec.ts >> tRPC changeRole (internalProcedure) >> changes a user role from USER to CHEF
- Location: tests\auth\change-role.spec.ts:22:7

# Error details

```
Error: signup failed for test+1786287246599+d1bshewdf4@chefmate.test: {"result":{"data":{"userId":"6a789495bcaf660c09e36632","email":"test+1786287246599+d1bshewdf4@chefmate.test","role":"USER"}}}
