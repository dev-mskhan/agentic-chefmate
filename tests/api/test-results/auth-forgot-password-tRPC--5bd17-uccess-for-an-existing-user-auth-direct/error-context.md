...
- Name: auth\forgot-password.spec.ts >> tRPC forgotPassword >> returns success for an existing user
- Location: tests\auth\forgot-password.spec.ts:16:7

# Error details

```
Error: signup failed for forgot+1786287281149+tqrvf4dpyb@chefmate.test: {"result":{"data":{"userId":"6a7894b1bcaf660c09e3663d","email":"forgot+1786287281149+tqrvf4dpyb@chefmate.test","role":"USER"}}}
