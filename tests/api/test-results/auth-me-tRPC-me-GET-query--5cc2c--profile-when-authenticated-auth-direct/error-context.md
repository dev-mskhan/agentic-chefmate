...
- Name: auth\me.spec.ts >> tRPC me (GET query) >> returns current user profile when authenticated
- Location: tests\auth\me.spec.ts:15:7

# Error details

```
Error: signup failed for test+1786287291771+yupumox51qe@chefmate.test: {"result":{"data":{"userId":"6a7894bbbcaf660c09e36643","email":"test+1786287291771+yupumox51qe@chefmate.test","role":"USER"}}}
