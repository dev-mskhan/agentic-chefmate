...
- Name: auth\me.spec.ts >> tRPC me (GET query) >> me uses GET method (tRPC query transport)
- Location: tests\auth\me.spec.ts:32:7

# Error details

```
Error: signup failed for test+1786287293201+gr2v50r6e7g@chefmate.test: {"result":{"data":{"userId":"6a7894bdbcaf660c09e36648","email":"test+1786287293201+gr2v50r6e7g@chefmate.test","role":"USER"}}}
