...
- Name: auth\refresh.spec.ts >> tRPC refresh >> issues new token pair using valid refresh token
- Location: tests\auth\refresh.spec.ts:41:7

# Error details

```
Error: signup failed for refresh+1786287297965+q9ljbhh1ee9@chefmate.test: {"result":{"data":{"userId":"6a7894c2bcaf660c09e3664d","email":"refresh+1786287297965+q9ljbhh1ee9@chefmate.test","role":"USER"}}}
