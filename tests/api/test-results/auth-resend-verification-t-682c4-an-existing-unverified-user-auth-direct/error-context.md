...
- Name: auth\resend-verification.spec.ts >> tRPC resendVerification >> returns success for an existing unverified user
- Location: tests\auth\resend-verification.spec.ts:16:7

# Error details

```
Error: signup failed for resend+1786287307050+fago70wlv3s@chefmate.test: {"result":{"data":{"userId":"6a7894cbbcaf660c09e36657","email":"resend+1786287307050+fago70wlv3s@chefmate.test","role":"USER"}}}
