...
- Name: auth\signin.spec.ts >> tRPC signin >> returns 401 when password is wrong
- Location: tests\auth\signin.spec.ts:48:7

# Error details

```
Error: signup failed for signin-badpass+1786287340141+29pmc25aerr@chefmate.test: {"result":{"data":{"userId":"6a7894ecbcaf660c09e36668","email":"signin-badpass+1786287340141+29pmc25aerr@chefmate.test","role":"USER"}}}
