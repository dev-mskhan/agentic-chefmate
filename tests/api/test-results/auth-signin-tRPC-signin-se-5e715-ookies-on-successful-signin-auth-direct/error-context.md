...
- Name: auth\signin.spec.ts >> tRPC signin >> sets signed access and refresh cookies on successful signin
- Location: tests\auth\signin.spec.ts:29:7

# Error details

```
Error: signup failed for signin-cookies+1786287334897+b5bfwbcodd@chefmate.test: {"result":{"data":{"userId":"6a7894e7bcaf660c09e36662","email":"signin-cookies+1786287334897+b5bfwbcodd@chefmate.test","role":"USER"}}}
