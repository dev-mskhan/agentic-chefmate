...
- Name: auth\signin.spec.ts >> tRPC signin >> signs in an existing user and returns userId/email/role
- Location: tests\auth\signin.spec.ts:16:7

# Error details

```
Error: signup failed for signin+1786287331762+hplau8llsy@chefmate.test: {"result":{"data":{"userId":"6a7894e4bcaf660c09e3665d","email":"signin+1786287331762+hplau8llsy@chefmate.test","role":"USER"}}}
