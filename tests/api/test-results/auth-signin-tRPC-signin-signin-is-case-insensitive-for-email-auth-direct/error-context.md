...
- Name: auth\signin.spec.ts >> tRPC signin >> signin is case-insensitive for email
- Location: tests\auth\signin.spec.ts:81:7

# Error details

```
Error: signup failed for signin-case+1786287356579+breap3sjlho@chefmate.test: {"result":{"data":{"userId":"6a7894fdbcaf660c09e3666d","email":"signin-case+1786287356579+breap3sjlho@chefmate.test","role":"USER"}}}
