...
- Name: auth\signout.spec.ts >> tRPC signout >> access token is rejected after signout (token blacklisted)
- Location: tests\auth\signout.spec.ts:42:7

# Error details

```
Error: signup failed for test+1786287366485+0xqup9p9lrb@chefmate.test: {"result":{"data":{"userId":"6a789507bcaf660c09e3667c","email":"test+1786287366485+0xqup9p9lrb@chefmate.test","role":"USER"}}}
