...
- Name: auth\signout.spec.ts >> tRPC signout >> clears auth cookies on signout
- Location: tests\auth\signout.spec.ts:26:7

# Error details

```
Error: signup failed for test+1786287362714+ffpq06mbu7c@chefmate.test: {"result":{"data":{"userId":"6a789503bcaf660c09e36677","email":"test+1786287362714+ffpq06mbu7c@chefmate.test","role":"USER"}}}
