...
- Name: auth\signout.spec.ts >> tRPC signout >> signs out an authenticated user
- Location: tests\auth\signout.spec.ts:18:7

# Error details

```
Error: signup failed for test+1786287358558+jnefc4oebp@chefmate.test: {"result":{"data":{"userId":"6a7894ffbcaf660c09e36672","email":"test+1786287358558+jnefc4oebp@chefmate.test","role":"USER"}}}
