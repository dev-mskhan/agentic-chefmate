...
- Name: auth\signup.spec.ts >> tRPC signup >> registers a new user and returns userId/email/role
- Location: tests\auth\signup.spec.ts:16:7

# Error details

```
Error: Expected success=true, got: {"result":{"data":{"userId":"6a789509bcaf660c09e36681","email":"signup+1786287369228+dfqp2d7q07q@chefmate.test","role":"USER"}}}
